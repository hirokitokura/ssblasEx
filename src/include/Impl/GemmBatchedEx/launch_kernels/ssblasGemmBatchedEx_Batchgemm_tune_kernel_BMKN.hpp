#ifndef SSBLAS_LAUNCH_KERNELS_BMKN
#define SSBLAS_LAUNCH_KERNELS_BMKN
...
template<typename INDEXINT, typename T_SCALE, typename DEF_DOUBLE_AB, typename DEF_DOUBLE_C>
ssblasStatus_t ssblasGemmBatchedEx_Batchgemm_tune_BMKN_kernel_body
(
    ssblasEx::cpu::launcher::ssblasKernelHandle_t KernelHandle,
...
template<typename INDEXINT, typename T_SCALE, typename DEF_DOUBLE_AB, typename DEF_DOUBLE_C>
ssblasStatus_t ssblasGemmBatchedEx_Batchgemm_tune_BMKN_kernel
(
    ssblasEx::cpu::launcher::ssblasKernelHandle_t KernelHandle,
    ssblasOperation_t    transa,
    ssblasOperation_t    transb,
...
)
{
    ...
    ssblasGemmBatchedEx_Batchgemm_tune_BMKN_kernel_body
    <INDEXINT, T_SCALE, DEF_DOUBLE_AB, DEF_DOUBLE_C>
    (
        KernelHandle,
        transa,
...
template<typename INDEXINT, typename T_SCALE, typename DEF_DOUBLE_AB, typename DEF_DOUBLE_C>
ssblasStatus_t ssblasGemmBatchedEx_Batchgemm_tune_BMKN_host
(
    ssblasOperation_t    transa,
    ssblasOperation_t    transb,
    INDEXINT                  m,
...
)
{
    ...
    auto funcWrapper = BMKN_kernel::ssblasGemmBatchedEx_Batchgemm_tune_BMKN_kernel<INDEXINT, T_SCALE, DEF_DOUBLE_AB, DEF_DOUBLE_C>; 
